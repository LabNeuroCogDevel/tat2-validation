...
for rest in 1 2; do
  ...
  for input in ${visit_dirs[@]}; do
    ...
    final_out="/ocean/projects/soc230004p/shared/datasets/tat2/$ld8/pet$rest/_ref-vent3_time-median_vol-median_censor-fd0.3_calc-zscore_scale-none_tat2.nii.gz"
